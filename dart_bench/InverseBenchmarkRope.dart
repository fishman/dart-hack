...
//    ctx = canvas.getContext("2d");
    ...
    List args = opt.arguments;
//    for (String arg in args) {
//      write(arg);
//    }
    
    String strLength = args[0];
    
    strLen = Math.parseInt(strLength);
    
    if (args.length > 1 && args[1] == 'rope') {
//      write("Rope impl");
      OperationCBIF cb = new DefaultConcatOperation();
      bulkTestDataTemplate(cb, "Rope", "orange");
    } else {
//      write("Normal impl");
      OperationCBIF cb = new DefaultConcatOperation();
...
//    timedTest(640, cb, concatType);
    ...
    timedTest(strLen, cb, concatType);
//
//    timedTest(640, cb, concatType);
//    timedTest(1280, cb, concatType);
//    timedTest(2560, cb, concatType);
...
//  CanvasRenderingContext2D ctx;
  ...
  static final int TEST_TIME = 500000;
